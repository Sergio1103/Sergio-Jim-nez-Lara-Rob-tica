...
#Animación del desplazamiento en Z
def animate_shift_Z(steps=20, shift=10):
    """
    Esta función anima el desplazamiento de la caja en el eje Z.
    steps → número de pasos de la animación (controla suavidad/velocidad).
    shift → cuánto se mueve en total la caja en Z.
    """
    ...
    while n <= steps:
        ...
        # Desplazamiento proporcional en Z
        # (shift/steps) es cuánto avanza la caja por cada paso
        dz = (shift/steps)*n

        # Aplicar desplazamiento a cada punto de la caja en Z
        p1 = p1_init + [0,0,dz]
        p2 = p2_init + [0,0,dz]
        p3 = p3_init + [0,0,dz]
        p4 = p4_init + [0,0,dz]
        ...
        # Dibuja la caja en su nueva posición desplazada en Z
...
# la caja se moverá 15 unidades en Z en 30 pasos
animate_shift_Z(steps=30, shift=15)
